...
public class AppUtils {
	 ...
	 * @return
	 */
	public static String getForegroundApp(Context paramContext) {
		List<RunningTaskInfo> localList = ((ActivityManager) paramContext
				.getSystemService(Context.ACTIVITY_SERVICE)).getRunningTasks(1);
//		((ActivityManager.RunningTaskInfo) localList.get(0)).topActivity
//				.getClassName();
		return ((RunningTaskInfo) localList.get(0)).topActivity
				.getPackageName();
	}
	 ...
	 * @return
	 */
	public static boolean isSystemApp(Context paramContext, String pname) {
		try {
			PackageInfo pInfo = paramContext.getPackageManager()
					.getPackageInfo(pname, 0);
